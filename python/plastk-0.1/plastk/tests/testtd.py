...
$Id: testtd.py 229 2008-03-03 04:38:00Z jprovost $
"""
import unittest
from plastk.base.parameterizedobject import ParameterizedObject
from plastk.base import WARNING
import plastk.misc.pkl as pkl
from plastk.rl import gridworld
...
class TestTDGridWorld(unittest.TestCase):
    ...
    def testMain(self):
        ...
        self.assertEqual(self.rli.episode_data['length'][-1], self.correct_length)
        self.assertEqual(self.rli.episode_data['reward'][-1],self.correct_reward)
