...
$Id: testfnapprox.py 229 2008-03-03 04:38:00Z jprovost $
"""

import unittest
import plastk.base as rand
...
class TestFnApprox(unittest.TestCase):
    ...
    def testUniform(self):
        ...
        self.fn.verbose( "avg err =", total_err/len(self.test_data))
        failure_rate = failures/float(len(self.test_data))
        self.fn.verbose("%.1f%% Failure" % (failure_rate * 100))
