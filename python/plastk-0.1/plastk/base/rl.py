...
The class RLI is a very simple RL Interface.  For an interface with
lots of bells and whistles, including a GUI and the ability to
log arbitrary run data into files, see plastk.rl.loggingrli.LoggingRLI.

$Id: rl.py 229 2008-03-03 04:38:00Z jprovost $
"""

from numpy import zeros,argmax
from math import exp,log

from params import ParameterizedObject, Parameter


TERMINAL_STATE = "terminal"


class Agent(ParameterizedObject):
    """
...
class Environment(ParameterizedObject):
    """
