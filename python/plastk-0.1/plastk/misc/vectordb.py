...
$Id: vectordb.py 229 2008-03-03 04:38:00Z jprovost $
"""

import plastk.base.parameterizedobject as paramobj
from plastk.base.parameterizedobject import DEBUG,classlist
from plastk.misc.utils import best_N_destructive,norm,matrixnorm

from numpy import sometrue,array,argsort,flatnonzero as nonzero
...
class VectorDB(object):
    ...
    def debug(self,*args):
        if paramobj.min_print_level >= DEBUG:
