...
$Id: pkl.py 229 2008-03-03 04:38:00Z jprovost $
"""
import os,re,gzip
...
class pgen(object):
    ...
    may be computationally expensive.  Worse, for some generator
    objects it may not generate correct output, or even work at all.
    (e.g. for those that depend on the concurrently changing state of
    some other object.)
    """
