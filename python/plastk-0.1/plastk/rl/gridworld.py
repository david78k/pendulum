"""
Environments for grid-based navigation.

A simple grid-based Markov decision process environment.  The agent's
state is one cell   With walls and a goal. Actions move the agent
north, south, east or west, and can be determinstic or stochastic.

$Id: gridworld.py 229 2008-03-03 04:38:00Z jprovost $
"""
from numpy import array

import plastk.base.rl as rl
import plastk.base.rand as rand
import plastk.misc.utils as utils
from plastk.base.params import Parameter,Number,Integer,Magnitude,Boolean
