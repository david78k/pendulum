...
$Id: gng.py 229 2008-03-03 04:38:00Z jprovost $
"""

from plastk.base.params import ParameterizedObject
from plastk.base.vq import VQ
from plastk.misc.utils import matrixnorm,norm,inf,gaussian
from numpy import exp,argsort,argmin,dot,sqrt,take,zeros,average,array,concatenate as join
from plastk.base.params import Parameter,Integer,Magnitude,Number
...
class GNGUnit(ParameterizedObject):
...
try:
    ...
    class GNG2DDisplay(ParameterizedObject,Tk.Frame):
        tkargs = Parameter(default={})
        update_period = Integer(default=500,bounds=(0,None))
        gng = Parameter(default=None)
        def __init__(self,root,**args):

            ParameterizedObject.__init__(self,**args)
