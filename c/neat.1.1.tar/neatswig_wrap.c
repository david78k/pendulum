...
void glist() {
	 gh_new_procedure("testdoubval", _wrap_gscm_testdoubval, 0, 0, 0);
	 gh_new_procedure("testdoubset", _wrap_gscm_testdoubset, 1, 0, 0);
	 gh_new_procedure("new_NNode3arg", _wrap_gscm_new_NNode3arg, 3, 0, 0);
	 gh_new_procedure("NEWNODE", _wrap_gscm_var_NEWNODE, 0, 1, 0);
	 gh_new_procedure("NEWLINK", _wrap_gscm_var_NEWLINK, 0, 1, 0);
	 gh_new_procedure("new_Genome_fromfile", _wrap_gscm_new_Genome_fromfile, 2, 0, 0);
	 gh_new_procedure("display_Genome", _wrap_gscm_display_Genome, 3, 0, 0);
	 gh_new_procedure("new_Genome_load", _wrap_gscm_new_Genome_load, 1, 0, 0);
	 gh_new_procedure("print_Genome_tofile", _wrap_gscm_print_Genome_tofile, 2, 0, 0);
	 gh_new_procedure("print_Genome", _wrap_gscm_print_Genome, 1, 0, 0);
	 gh_new_procedure("new_Pop_fromfile", _wrap_gscm_new_Pop_fromfile, 1, 0, 0);
	 gh_new_procedure("new_Pop_fromGenomefile", _wrap_gscm_new_Pop_fromGenomefile, 1, 0, 0);
	 gh_new_procedure("xor_epoch", _wrap_gscm_xor_epoch, 6, 0, 0);
	 gh_new_procedure("new_innov_list", _wrap_gscm_new_innov_list, 0, 0, 0);
	 gh_new_procedure("xor_test", _wrap_gscm_xor_test, 1, 0, 0);
	 gh_new_procedure("xor_evaluate", _wrap_gscm_xor_evaluate, 1, 0, 0);
	 gh_new_procedure("pole1_test", _wrap_gscm_pole1_test, 1, 0, 0);
	 gh_new_procedure("pole1_evaluate", _wrap_gscm_pole1_evaluate, 1, 0, 0);
	 gh_new_procedure("pole2_test", _wrap_gscm_pole2_test, 2, 0, 0);
	 gh_new_procedure("pole2_evaluate", _wrap_gscm_pole2_evaluate, 3, 0, 0);
	 gh_new_procedure("Network_name_set", _wrap_gscm_Network_name_set, 2, 0, 0);
	 gh_new_procedure("Network_name_get", _wrap_gscm_Network_name_get, 1, 0, 0);
	 gh_new_procedure("Network_net_id_set", _wrap_gscm_Network_net_id_set, 2, 0, 0);
	 gh_new_procedure("Network_net_id_get", _wrap_gscm_Network_net_id_get, 1, 0, 0);
	 gh_new_procedure("delete_Network", _wrap_gscm_delete_Network, 1, 0, 0);
	 gh_new_procedure("Network_flush", _wrap_gscm_Network_flush, 1, 0, 0);
	 gh_new_procedure("Network_activate", _wrap_gscm_Network_activate, 1, 0, 0);
	 gh_new_procedure("Network_show_activation", _wrap_gscm_Network_show_activation, 1, 0, 0);
	 gh_new_procedure("Network_add_input", _wrap_gscm_Network_add_input, 2, 0, 0);
	 gh_new_procedure("Network_add_output", _wrap_gscm_Network_add_output, 2, 0, 0);
	 gh_new_procedure("Network_load_sensors", _wrap_gscm_Network_load_sensors, 2, 0, 0);
	 gh_new_procedure("Network_give_name", _wrap_gscm_Network_give_name, 2, 0, 0);
	 gh_new_procedure("Network_nodecount", _wrap_gscm_Network_nodecount, 1, 0, 0);
	 gh_new_procedure("Network_linkcount", _wrap_gscm_Network_linkcount, 1, 0, 0);
	 gh_new_procedure("Network_input_start", _wrap_gscm_Network_input_start, 1, 0, 0);
	 gh_new_procedure("Network_load_in", _wrap_gscm_Network_load_in, 2, 0, 0);
	 gh_new_procedure("Network_graph", _wrap_gscm_Network_graph, 3, 0, 0);
	 gh_new_procedure("Genome_genome_id_set", _wrap_gscm_Genome_genome_id_set, 2, 0, 0);
	 gh_new_procedure("Genome_genome_id_get", _wrap_gscm_Genome_genome_id_get, 1, 0, 0);
	 gh_new_procedure("Genome_phenotype_set", _wrap_gscm_Genome_phenotype_set, 2, 0, 0);
	 gh_new_procedure("Genome_phenotype_get", _wrap_gscm_Genome_phenotype_get, 1, 0, 0);
	 gh_new_procedure("new_Genome", _wrap_gscm_new_Genome, 2, 0, 0);
	 gh_new_procedure("delete_Genome", _wrap_gscm_delete_Genome, 1, 0, 0);
	 gh_new_procedure("Genome_genesis", _wrap_gscm_Genome_genesis, 2, 0, 0);
	 gh_new_procedure("Genome_print_to_file", _wrap_gscm_Genome_print_to_file, 2, 0, 0);
	 gh_new_procedure("Genome_duplicate", _wrap_gscm_Genome_duplicate, 2, 0, 0);
	 gh_new_procedure("Genome_mutate_random_trait", _wrap_gscm_Genome_mutate_random_trait, 1, 0, 0);
	 gh_new_procedure("Genome_mutate_link_trait", _wrap_gscm_Genome_mutate_link_trait, 2, 0, 0);
	 gh_new_procedure("Genome_mutate_node_trait", _wrap_gscm_Genome_mutate_node_trait, 2, 0, 0);
	 gh_new_procedure("Genome_mutate_link_weights", _wrap_gscm_Genome_mutate_link_weights, 4, 0, 0);
	 gh_new_procedure("Genome_mutate_toggle_enable", _wrap_gscm_Genome_mutate_toggle_enable, 2, 0, 0);
	 gh_new_procedure("Genome_mutate_gene_reenable", _wrap_gscm_Genome_mutate_gene_reenable, 1, 0, 0);
	 gh_new_procedure("Genome_mutate_add_node", _wrap_gscm_Genome_mutate_add_node, 4, 0, 0);
	 gh_new_procedure("Genome_mutate_add_link", _wrap_gscm_Genome_mutate_add_link, 4, 0, 0);
	 gh_new_procedure("Genome_mate_multipoint", _wrap_gscm_Genome_mate_multipoint, 5, 0, 0);
	 gh_new_procedure("Genome_mate_multipoint_avg", _wrap_gscm_Genome_mate_multipoint_avg, 5, 0, 0);
	 gh_new_procedure("Genome_mate_singlepoint", _wrap_gscm_Genome_mate_singlepoint, 3, 0, 0);
	 gh_new_procedure("Genome_compatibility", _wrap_gscm_Genome_compatibility, 2, 0, 0);
	 gh_new_procedure("Population_epoch", _wrap_gscm_Population_epoch, 2, 0, 0);
	 gh_new_procedure("Population_visualize", _wrap_gscm_Population_visualize, 5, 0, 0);
{
   int i;
