...
for i = 1: 5,  
    ...
    factor2 = RHOH * rhat * z(i) * (1 - z(i)) * sign(f(i)) * unusualness;
    for j = 1:5,    
        % for each weight I-H
    ...
    e(i) = e(i) + RHO * rhat * unusualness * xold(i);   % action network I-O
    f(i) = f(i) + RHO * rhat * unusualness * z(i);   % action network H-O
end
