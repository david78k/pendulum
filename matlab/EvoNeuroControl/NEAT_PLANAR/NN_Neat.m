...
number_connections = size(individual.connectiongenes,2);
      ...
      individual.nodegenes(3,input_nodes+1)=deg2rad(90); %bias node input state set to deg2rad(90)
      ...
      individual.nodegenes(4,input_nodes+2:number_nodes) =  2.0*deg2rad(90)./(1.+exp(-1 .*n))-deg2rad(90);     
