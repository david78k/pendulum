...
mh(3,1,1,1) = uimenu(mh3,'Label', 'GrossbergPilly (2008)');
...
% mh(5,1,1,1) = uimenu(mh5,'Label', 'Examples come here');
% mh(5,1,2,1) = uimenu(mh5,'Label', 'Input');

% For menu bar item: 'Run'
mh5 = uimenu(fh,'Label', 'Run');
mh(5,1,1,1) = uimenu(mh5,'Label', 'Load an image and spike!');
...
set(mh(3,1,1,1),'callback', {@opendoc1_Callback 'GrossbergPilly_VisionRes2008.pdf'});
...
set(mh(6,1,1,1),'callback', {@run1_Callback 'reducedSpikingDemo'});
