...
% using SimMechanics.
%
% <<../Figures/pendulum1.png>>
%
% *Figure 1: Inverted pendulum on a cart*
%
% <<../Figures/pendulum2.png>>
%
% *Figure 2: SimMechanics model*
%
...
MinDamping = 0.5;
MaxFrequency = 45;
% req4 = TuningGoal.Poles(0,MinDamping,MaxFrequency); // r2014b
req4 = TuningGoal.Poles();
req4.MinDecay = 0;
req4.MinDamping = MinDamping;
req4.MaxFrequency = MaxFrequency;
